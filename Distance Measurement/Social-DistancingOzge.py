...
while True:
    ...
    if len(face_cor) == 0:
        ...
        if D<300 and D!=0:
            ...
            photo = cv2.putText(photo, "!!Keep Social Distance!!", (100, 100), cv2.FONT_HERSHEY_SIMPLEX,2, [0,0,255] , 4)

        photo = cv2.putText(photo, str(D/10+120) + " cm", (300, 50), cv2.FONT_HERSHEY_SIMPLEX,
                   1, (255, 0, 0) , 2, cv2.LINE_AA)

        cv2.imshow('SpecialCase Robot/Distance Detection' , photo)
